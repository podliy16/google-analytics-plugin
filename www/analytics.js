...
UniversalAnalyticsPlugin.prototype.addCustomMetric = function(key, value, success, error) {
  cordova.exec(success, error, 'UniversalAnalytics', 'addCustomMetric', [key, value]);
};
